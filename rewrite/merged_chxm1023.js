...
## Aliya.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 应用名称：Aliya记梦器
# 脚本功能：年会员
...
## Aliya.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Cardify.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 应用名称：Cardify-AI错题本
# 脚本功能：终身会员
...
## Cardify.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Glass.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 应用名称：Glass-摄影社区
# 脚本功能：解锁Patron
...
## Glass.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## PomodoroToDo.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 应用名称：专注清单-番茄钟&任务清单
...
## PomodoroToDo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## aidoucang.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 应用名称：AI豆仓
# 脚本功能：高级会员
...
## aidoucang.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## chaojizhitu.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 应用名称：超级制图
# 脚本功能：会员功能
...
## chaojizhitu.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dsxys.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 应用名称：大师兄/橘子影视
# 脚本功能：解锁VIP
...
## dsxys.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xtdcfx.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 应用名称：系统电池分析
...
## xtdcfx.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
