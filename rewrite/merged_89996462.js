## 13app.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：13个APP解锁全家桶
...
## 13app.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 149.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：香蕉短剧——解锁VIP
...
## 149.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 1jiaofei8.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：语音转换文字——解锁VIP
...
## 1jiaofei8.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 1yifanxinmei.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：水印相机——解锁VIP
...
## 1yifanxinmei.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 233.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 223网校——解锁视频观看
...
## 233.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 2jiaofei8.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：照片格式转换——解锁VIP
...
## 2jiaofei8.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 51wnlcq.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：恋相遇——解锁VIP
...
## 51wnlcq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 51wnlcq1.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：子午觉——解锁VIP
...
## 51wnlcq1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 6open.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：6open一解锁下载功能
...
## 6open.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## 7d.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## AAnybox.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## AAnybox.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] AITXG.js 中包含 buy.itunes.apple.com，已删除
## APTV.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：APTV-+解锁订阅
...
## APTV.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] AVOD.js 中包含 buy.itunes.apple.com，已删除
# [删除] AXTQ.js 中包含 buy.itunes.apple.com，已删除
...
# [删除] AllMyBatteries.js 中包含 buy.itunes.apple.com，已删除
# [删除] AnkiNote.js 中包含 buy.itunes.apple.com，已删除
# [删除] Annual.js 中包含 buy.itunes.apple.com，已删除
## Apollo.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## Apollo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ArtWidgets.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
...
## ArtWidgets.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Arte.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Arte——解锁订阅
...
## Arte.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## AudioPlayer.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## AudioPlayer.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] BL.js 中包含 buy.itunes.apple.com，已删除
# [删除] Bazaart.js 中包含 buy.itunes.apple.com，已删除
# [删除] BeatPulse.js 中包含 buy.itunes.apple.com，已删除
# [删除] BodyApp.js 中包含 buy.itunes.apple.com，已删除
## Busuu.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：博树 Busuu-+解锁VIP
# 特别说明：如解锁不了 ，请你先试用一次！
...
## Busuu.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]

^https:\/\/api\.busuu\.com\/users\/me url script-response-body https://raw.githubusercontent.com/89996462/Quantumult-X/main/ycdz/Busuu.js
#[mitm] 

# hostname = api.busuu.com

## CARROTWeather.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## CARROTWeather.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] CDAkskt.js 中包含 buy.itunes.apple.com，已删除
## CJJN.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：超级简历——解锁VIP
...
## CJJN.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] CapyMood.js 中包含 buy.itunes.apple.com，已删除
## ChatAl40.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## ChatAl40.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Chic.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Chic.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Clica.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：Clica——解锁订阅
...
## Clica.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] CollageMaker.js 中包含 buy.itunes.apple.com，已删除
...
## ColorWidgets.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## ColorWidgets.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] ColorfulWidget.js 中包含 buy.itunes.apple.com，已删除
## Converter.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Converter.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Currency.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: Currency——解锁订阅
...
## Currency.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## DBSS.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## DBSS.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## DSY.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：倒数鸭——解锁订阅
...
## DSY.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] DVD.js 中包含 buy.itunes.apple.com，已删除
...
## EFEKT.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## EFEKT.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Emote.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Emote.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## FYQNW.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：翻译全能王
...
## FYQNW.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] Facey.js 中包含 buy.itunes.apple.com，已删除
# [删除] FitnessView.js 中包含 buy.itunes.apple.com，已删除
## FoMz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：FoMz——解锁VIP
...
## FoMz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] FocusVideo.js 中包含 buy.itunes.apple.com，已删除
## GUGA.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## GUGA.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## GentlerStreak.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## GentlerStreak.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Grow.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Grow - 你的健康+恢复订阅
...
## Grow.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] GuitarTuner.js 中包含 buy.itunes.apple.com，已删除
## HX.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：幻休-睡眠记录——解锁VIP
...
## HX.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Happy.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Happy.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## HiWidget.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## HiWidget.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] Iam.js 中包含 buy.itunes.apple.com，已删除
# [删除] ImgPlay.js 中包含 buy.itunes.apple.com，已删除
## Invideo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Invideo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## JPEG.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## JPEG.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## JRSYXJ.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：今日水印相机——解锁会员
...
## JRSYXJ.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## JRSYXJ1.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：今日水印相机——解锁会员
# 下载地址：https://is.gd/0ueVsQ
...
## JRSYXJ1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## JX.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## JZSP.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：减脂食谱+解锁VIP
...
## JZSP.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] KLBZ.js 中包含 buy.itunes.apple.com，已删除
## KP.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：开拍——解锁VIP
...
## KP.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Kotodama.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Kotodama.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] LYJ.js 中包含 buy.itunes.apple.com，已删除
# [删除] LYZYB.js 中包含 buy.itunes.apple.com，已删除
## Lifeviewer.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Lifeviewer.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## LimiCam.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## LimiCam.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Lingokids.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Lingokids.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## LiveWallpaper.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：动态壁纸大全——解锁订阅
...
## LiveWallpaper.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Lungy.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Lungy.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## LyBJ.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：录音笔记-解锁会员
...
## LyBJ.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Memrise.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Memrise.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## MolyCam.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：MolyCam+解锁PRO
# 下载地址：https://is.gd/LomGzV
# 软件版本：1.5.1
# 脚本作者：彭于晏💞
# 更新时间：2022-9-29
# 问题反馈：QQ+89996462
...
## MolyCam.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Mondly.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Mondly.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] Motivation.js 中包含 buy.itunes.apple.com，已删除
## NexCam.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本作者：彭于晏💞
# 更新时间：2026-6—16
...
## NexCam.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Nicegrampro.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Nicegrampro.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## NotBoring.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## NotBoring.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Now.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Now.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## OneTodo.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## OneTodo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## PDFExpert.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## PDFExpert.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## PDFViewer.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## PDFViewer.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Pedometer.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Pedometer++——解锁订阅
...
## Pedometer.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] Photable.js 中包含 buy.itunes.apple.com，已删除
## Photo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Photo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## PhotoRoom.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## PhotoRoom.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Photoshop.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Photoshop.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] Picsew.js 中包含 buy.itunes.apple.com，已删除
## Pillow.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Pillow.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Pixelance.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Pixelance.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Pixelmator.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Pixelmator.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Planny.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Planny.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] ProCamera.js 中包含 buy.itunes.apple.com，已删除
# [删除] Proknockout.js 中包含 buy.itunes.apple.com，已删除
## Pure.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Pure记账——解锁订阅
...
## Pure.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## PureLibro.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：PureLibro——解锁订阅
...
## PureLibro.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Quike.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Quike.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ReelMaker.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## ReelMaker.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] Retake.js 中包含 buy.itunes.apple.com，已删除
## SP.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：诗片——解锁订阅
...
## SP.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## SXCSCX.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：事线-串事成线——解锁订阅
...
## SXCSCX.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Scanner.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## Scanner.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ScreenRecordCase.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：屏幕套壳——解锁订阅
...
## ScreenRecordCase.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ServerBee.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：ServerBee——解锁订阅
...
## ServerBee.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Seven.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：7分钟HIT运动+解锁订阅
...
## Seven.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Sharp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Sharp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Silimini.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: Silimini——解锁VIP
...
## Silimini.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] Smart.js 中包含 buy.itunes.apple.com，已删除
## Sorted.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Sorted.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Soul.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## Soul.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## SparkMail.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## SparkMail.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## StressWatch.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## StressWatch.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Structured.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Structured.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## StyleArt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## StyleArt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## THLY.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：通话录音——解锁订阅
...
## THLY.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## TTTS.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：天天跳绳——解锁VIP
...
## TTTS.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Tangerine.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Tangerine——解锁订阅
...
## Tangerine.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Todo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Todo清单+解锁VIP
...
## Todo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ToonMe.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## ToonMe.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## TouchRetouch.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## TouchRetouch.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Usage.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Usage.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## VCUS.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## VCUS.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## VIBECAM.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：VIBE CAM——解锁订阅
...
## VIBECAM.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## VIPALL.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：美妆日历——解锁订阅
...
## VIPALL.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Varlens.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## Varlens.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] WXS.js 中包含 buy.itunes.apple.com，已删除
# [删除] WasteCat.js 中包含 buy.itunes.apple.com，已删除
## Watchoutc.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：WoW 小组件——解锁VIP
...
## Watchoutc.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Weather.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## Weather.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## WeatherFit.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
...
## WeatherFit.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## WidgetArt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## WidgetArt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Wink.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：同时解锁以下APP软件
# 
...
## Wink.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## XBLXPY.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 小伴龙拼音——解锁VIP
...
## XBLXPY.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## XBLXSX.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## XBLXSX.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] XGGj.js 中包含 buy.itunes.apple.com，已删除
## XLJY.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：迅游加速器——解锁VIP
...
## XLJY.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## XLSW.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：小鹿声文——解锁时长
...
## XLSW.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] XSHRL.js 中包含 buy.itunes.apple.com，已删除
## XWink.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：Wink +解锁订阅
...
## XWink.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] XXBq.js 中包含 buy.itunes.apple.com，已删除
...
## XXLP.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：小熊录屏——解锁VIP
# 特别说明：需要试用一次！！！
...
## XXLP.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## XXjz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：小熊记账——解锁订阅
...
## XXjz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## XZKp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：小作卡片——解锁VIP
...
## XZKp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## Xcrj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：星垂日记-——解锁VIP
...
## Xcrj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] Xjzz.js 中包含 buy.itunes.apple.com，已删除
# [删除] Xmdsz.js 中包含 buy.itunes.apple.com，已删除
## YDLD.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：有道乐读——解锁所有视频
...
## YDLD.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## YLKS.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：咿啦看书——解锁VIP
...
## YLKS.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## YSBJ.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：元思笔记——解锁订阅
...
## YSBJ.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] You.js 中包含 buy.itunes.apple.com，已删除
## ZMJH.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：朝暮计划+解锁VIP
...
## ZMJH.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ZMU.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 朝暮——解锁订阅
...
## ZMU.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## abushuiqiangushi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 阿布睡前故事+解锁会员
...
## abushuiqiangushi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## aifaceapi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：映月相机——解锁VIP
...
## aifaceapi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## aihlx.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：AI换脸秀+解锁VIP
...
## aihlx.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## aijpq.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 扑克记牌器
# TG反馈群：https://t.me/plus8889
...
## aijpq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## aimusician.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Al设计师——解锁VIP
...
## aimusician.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## aimusician1.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：旅行订单生成专家——解锁VIP
...
## aimusician1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## aizhengjian.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：爱证件——解锁VIP
...
## aizhengjian.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## amkj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：蜜糖小剧场——解锁VIP
...
## amkj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## apisrv.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：宝维助手——解锁VIP
...
## apisrv.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## arpdf.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：傲软PDF编辑+解锁VIP
# 脚本功能：傲软扫描+解锁VIP
...
## arpdf.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## arqt.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## arqt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## artp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：傲软投屏-+解锁VIP
...
## artp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## askquin.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Quin——解锁VIP
...
## askquin.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## assistantwriter.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：文案生成器——解锁VIP
...
## assistantwriter.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## atlcz.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：凹凸啦查妆——解锁订阅
...
## atlcz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## axinzhi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：新知卫星地——解锁VIP
...
## axinzhi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## azt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：爱主题——解锁订阅
...
## azt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## bdwk.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## bdwk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] bgjj.js 中包含 buy.itunes.apple.com，已删除
## bhjk.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：薄荷健康+解锁超级会员
...
## bhjk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] biaogedashi.js 中包含 buy.itunes.apple.com，已删除
## bj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：B612咔叽+解锁VIP
...
## bj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## blocker.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：1blocker+解锁订阅
...
## blocker.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## bmhb.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：斑马海报+解锁终身会员
...
## bmhb.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## bmsm.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：白猫扫描-——解锁VIP
...
## bmsm.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## boshangxiaomai.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：博商小麦+解锁会员内容
...
## boshangxiaomai.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## budingsuoping.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## budingsuoping.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## budsP.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：布丁锁屏-DIY锁屏组件+解锁订阅
# 下载地址：https://is.gd/y0cmbV
...
## budsP.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## bytq.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## bytq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## bzdsrf.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：不折叠输入法——解锁VIP
...
## bzdsrf.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] bzyq1.js 中包含 buy.itunes.apple.com，已删除
## caishi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：才士题库+解锁观看限制
...
## caishi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## calendar.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## calendar.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## camera360.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：MIX2人像大师——解锁VIP
...
## camera360.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## cdmgkj.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：工地记工——解锁VIP
...
## cdmgkj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## cdzs.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：充电助手-+解锁VIP
...
## cdzs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ceo.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## ceo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## chatai.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## chatai.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## chatgdp4.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## chatgdp4.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## chatmoon.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 情侣飞行棋——解锁pro
...
## chatmoon.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## chazhuang.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：查妆妆——解锁订阅
...
## chazhuang.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## chinaeew.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：地震预警——解锁VIP
...
## chinaeew.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## chuangqi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 中华诗词库——解锁VIP
...
## chuangqi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## cjapi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：悟饭乐享——解锁VIP
...
## cjapi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## clean.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：魔法消除鸭+解锁订阅
...
## clean.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] clipTrim.js 中包含 buy.itunes.apple.com，已删除
## codye.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：codye——解锁订阅
...
## codye.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## compass.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：指南针GPS——解锁VIP
...
## compass.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## comyjt.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 易截图2——解锁会员
...
## comyjt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## cpdq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：菜谱大全+解锁VIP
...
## cpdq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## cpp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 车票票——解锁订阅
...
## cpp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] ctpj.js 中包含 buy.itunes.apple.com，已删除
# [删除] ctpjq.js 中包含 buy.itunes.apple.com，已删除
## cubox.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## cubox.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## cyapi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：彩云天气+解锁订阅
...
## cyapi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dXyk.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：丁香医考+解锁题库
...
## dXyk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## darkroom.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## darkroom.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dasyibalang.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：指尖时光+解锁VIP
...
## dasyibalang.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## db.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ddcs.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 点点穿书——解锁闪币
...
## ddcs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ddqd.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：滴答清单+解锁VIP
...
## ddqd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## deliocr.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：无影pro——解锁VIP
...
## deliocr.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] dftz.js 中包含 buy.itunes.apple.com，已删除
## dgnspbj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：视频剪辑神器+解锁订阅
...
## dgnspbj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## diangongjsq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 电工计算器——解锁订阅
...
## diangongjsq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dicallapp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：配音——解锁VIP
...
## dicallapp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## djcsj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：DJ串烧库
# 软件版本：v2.0
...
## djcsj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## djcsk.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：DJ串烧库
# 软件版本：v2.0
...
## djcsk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## djxs.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：得间小说——解锁VIP
...
## djxs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## doctorsclass.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：医课——解锁VIP
...
## doctorsclass.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## documents.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## documents.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dofm.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: Dofm——解锁会员
...
## dofm.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## doglobal.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：魔图——解锁VIP
...
## doglobal.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dolphinmedia.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 海豚🐬儿童英语(解锁内容)
...
## dolphinmedia.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dsXy.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：大神水印——解锁VIP
...
## dsXy.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## duoman.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：多漫——解锁VIP
...
## duoman.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## duoyolo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：蜜柚短剧——解锁VIP
...
## duoyolo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dyad.js 从第1行到 [rewrite_local] 前一行：
# /*
# 
...
## dyad.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dydj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：大鱼短剧会员解锁
# 脚本作者：彭于晏💞
...
## dydj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dygdj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：电音阁dj——解锁VIP
...
## dygdj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## dzqjzz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：电子请柬制作+解锁VIP
...
## dzqjzz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## egdd.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：儿歌点点+解锁VIP
...
## egdd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ego.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## ego.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## enlargemagic.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 哆咪星球—无限刷礼物
...
## enlargemagic.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## everjournal.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：一万年日记——解锁VIP
...
## everjournal.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] fXXzj.js 中包含 buy.itunes.apple.com，已删除
# [删除] fabulous.js 中包含 buy.itunes.apple.com，已删除
...
## fbapi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：完美身材——解锁VIP
...
## fbapi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## feihua100.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## feihua100.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## fenbeiyi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 分贝仪+解锁订阅
...
## fenbeiyi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## fengkuangapp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：疯狂背单词+解锁VIP
...
## fengkuangapp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] fightenegery.js 中包含 buy.itunes.apple.com，已删除
...
## fin.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## fin.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## fkxxx.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：疯狂消消消+无限钻石金币
# 下载地址：#微信小程序://疯狂消消消
...
## fkxxx.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] flashtransport.js 中包含 buy.itunes.apple.com，已删除
# [删除] flashtransport1.js 中包含 buy.itunes.apple.com，已删除
## flomo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## flomo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## flowkey.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## flowkey.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## flyingeffect.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：拿捏驾考——解锁VIP
...
## flyingeffect.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## fuyoutech.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 杂志天下——解锁VIP
...
## fuyoutech.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## fyjh.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：飞鱼计划+解锁VIP
...
## fyjh.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ganbuguo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：闹钟+解锁VIP
...
## ganbuguo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## gaohaozuowen.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：稿好作文——解锁VIP
...
## gaohaozuowen.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## gateway.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Uplens+解锁订阅
...
## gateway.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## gateway1.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：团团记账——解锁VIP
...
## gateway1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## gdwxinzhi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：律动鼓点舞——解锁VIP
...
## gdwxinzhi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## gear.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## gear.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## gglqm.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：瓜瓜龙启蒙一解锁VIP
...
## gglqm.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] gifmaker.js 中包含 buy.itunes.apple.com，已删除
## gigabody.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：gigabody——解锁订阅
...
## gigabody.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] gjlahs.js 中包含 buy.itunes.apple.com，已删除
# [删除] glsrf.js 中包含 buy.itunes.apple.com，已删除
## gql.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：过期啦——解锁VIP
...
## gql.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## gscdq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：古诗词大全——解锁VIP
...
## gscdq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## guniuniu.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：题材库——解锁VIP权限
# 下载地址：微信小程序
...
## guniuniu.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] gyXt.js 中包含 buy.itunes.apple.com，已删除
## gzrz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：格志日记+解锁订阅
...
## gzrz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## haijiao.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：海角社区视频解析脚本
...
## haijiao.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## haitubangong.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：迷你小组件全家桶——解锁VIP
...
## haitubangong.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## haitunwallet.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：海豚记账本——解锁VIP
...
## haitunwallet.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] hanchongzan.js 中包含 buy.itunes.apple.com，已删除
## haokanke.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：漫画相机——解锁VIP
...
## haokanke.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## haoqimiao.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## haoqimiao.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hasmash.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：边框水印大师——解锁VIP
...
## hasmash.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hbetgs.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 汉堡儿童故事——解锁会员
# 脚本作者：彭于晏💞
...
## hbetgs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hbgc.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：海报工厂——解锁VIP
# 下载地址：https://t.cn/A66WBa0v
...
## hbgc.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hcreator.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## hcreator.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## helloshiyu.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：少女壁纸——解锁VIP
...
## helloshiyu.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] hfbyd.js 中包含 buy.itunes.apple.com，已删除
## hlzz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：航旅追踪+解锁订阅
...
## hlzz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hsfs.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：好事发生+解锁订阅
...
## hsfs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] https.js 中包含 buy.itunes.apple.com，已删除
## huashijie.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 画世界——解锁VIP
# 脚本作者：彭于晏💞
...
## huashijie.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## huaya.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：画涯——解锁VIP
...
## huaya.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## huikao8.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 慧考智学+解锁题库
...
## huikao8.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hujuvod.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：人人视频——解锁VIP
...
## hujuvod.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hula123.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：呼啦少儿英语——解锁VIP
...
## hula123.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## huojiwangluo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：听书助手——解锁VIP
...
## huojiwangluo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hxmh.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：火星漫画——解锁VIP内容
...
## hxmh.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hy.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## hyrz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：荒野日记—孤岛+无限贝壳
...
## hyrz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] hyxc.js 中包含 buy.itunes.apple.com，已删除
...
## hzk.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 汇中考——解锁会员
...
## hzk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## iScreen.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## iScreen.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## iScreenk.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## iScreenk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] iScreenn.js 中包含 buy.itunes.apple.com，已删除
...
## ifenghui.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## ifenghui.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] intolive.js 中包含 buy.itunes.apple.com，已删除
## io111.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：mg中文版——解锁VIP
...
## io111.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## iosbmxj.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：必美相机——解锁VIP
...
## iosbmxj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## iosqsy.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：魔法消除笔——解锁VIP
...
## iosqsy.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## iossjlplds.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：手机录屏大师——解锁VIP
...
## iossjlplds.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## iosxqsdnew.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：心情树洞——解锁VIP
# 下载地址：https://is.gd/4PemJT
...
## iosxqsdnew.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## iosyxdzyyxc.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：印象电子音乐相册——解锁VIP
# 下载地址：https://is.gd/4PemJT
...
## iosyxdzyyxc.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## iosznsmw.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：智能扫描王——解锁VIP
# 下载地址：https://is.gd/8yHbBx
...
## iosznsmw.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] isExpired.js 中包含 buy.itunes.apple.com，已删除
# [删除] itunes.js 中包含 buy.itunes.apple.com，已删除
## iwzbz.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：问真排版八字——解锁VIP
...
## iwzbz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ixyzh.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 小包搜题——解锁VIP
...
## ixyzh.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jggqt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：九宫格切图——解锁VIP
...
## jggqt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jgzl.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：抖音模拟器-解锁VIP
# 脚本作者：彭于晏💞
...
## jgzl.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jiangongjsq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 建工计算器——解锁VIP
...
## jiangongjsq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jianmovie.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称:  简影——(解锁会员)v6.9.0
...
## jianmovie.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] jianyibiaoge.js 中包含 buy.itunes.apple.com，已删除
## jianzhibao168cn.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：文案提取大师——解锁VIP
...
## jianzhibao168cn.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jiaofei8.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：抠图软件——解锁VIP
...
## jiaofei8.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jidiandian.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：星晴壁纸——解锁VIP
...
## jidiandian.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jietuguanjia.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：小歪微商——解锁VIP
...
## jietuguanjia.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jihu.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：记乎——解锁VIP
...
## jihu.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jingcle.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 柚子轻断食——解锁VIP
...
## jingcle.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jizhi.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：几枝——解锁VIP
...
## jizhi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jjrj.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：极简日记——解锁订阅
...
## jjrj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jjsz.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：极简时钟——解锁订阅
...
## jjsz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jkyd.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：即刻运动+解锁视频购买权限
...
## jkyd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jpjl.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 记牌精灵
# TG反馈群：https://t.me/plus8889
...
## jpjl.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jqzs.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：经期助手-——解锁VIP
...
## jqzs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] jrcy.js 中包含 buy.itunes.apple.com，已删除
## jrjy.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：今日解忧——解锁VIP
...
## jrjy.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jslynhapi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：水印相机——解锁VIP
...
## jslynhapi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] jsqari.js 中包含 buy.itunes.apple.com，已删除
...
## jtmnscq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：截图模拟生成神器——解锁VIP
...
## jtmnscq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## judouapp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：句读+解锁VIP
...
## judouapp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## julanling.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：安心记加班——解锁VIP
...
## julanling.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jumirui.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：视频舞蹈秀——解锁VIP
...
## jumirui.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## jxydt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：驾校一点通+解锁VIP
# 特别注意：必须v10.6.2版本
...
## jxydt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## kaiXinPai.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：开心拍——解锁会员
...
## kaiXinPai.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## keephu.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 微商截图秀——解锁会员
...
## keephu.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] kjXyy.js 中包含 buy.itunes.apple.com，已删除
## kkjp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## kkjp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## kkkjp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## kkkjp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## kky888.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：三维地图探索
# 软件版本：v1.2.7
...
## kky888.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## klkp.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：社恐快跑——解锁会员
...
## klkp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## kmovie.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：快影——解锁VIP
...
## kmovie.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] kprj.js 中包含 buy.itunes.apple.com，已删除
## ksyzkt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## ksyzkt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ktvme.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：K米——解锁VIP
...
## ktvme.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## kztb.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：快制图表-——解锁VIP
...
## kztb.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lalaldc.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 免耽漫画——解锁VIP
...
## lalaldc.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lalthsk.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：恋爱聊天话术库——解锁VIP
...
## lalthsk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## laoyingdev.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：美容修颜相机——解锁VIP
...
## laoyingdev.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lcon.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## lcon.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ldl.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：来电啦——解锁订阅
# 下载地址：https://is.gd/qayuJ0
...
## ldl.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## leminet.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：海报制作大师——解锁VIP
...
## leminet.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lgzj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：灵敢足迹——解锁高级会员
...
## lgzj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lianaishouce.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：雅俗共赏——解锁VIP
...
## lianaishouce.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lightroom.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## lightroom.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lingege.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：高定素材大师——解锁VIP
...
## lingege.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## linhongshi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：P图大神——解锁VIP
...
## linhongshi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ljgjcd.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## ljgjcd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ljtq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：莉景天气+解锁VIP
...
## ljtq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] lksyxj.js 中包含 buy.itunes.apple.com，已删除
## llsyd.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：流利说·阅读+解锁VIP
...
## llsyd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lmfasting.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：柠檬轻断食——解锁VIP
...
## lmfasting.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## loopsie.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## loopsie.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lovePdf.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## lovePdf.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## loveclip.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：爱剪辑——解锁VIP
...
## loveclip.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lovewith.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：婚礼精选——解锁付费内容
...
## lovewith.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ltXzj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：乃糖小组件+解锁VIP
...
## ltXzj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lths.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：聊天话术——解锁会员
...
## lths.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lunlunkj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：乐刷短剧——解锁VIP
...
## lunlunkj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## luv.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## luv.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ly.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## lyqjt.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## lyqjt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local] 
...
# [删除] lzds1.js 中包含 buy.itunes.apple.com，已删除
## lzjoy.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：虫虫吉他——解锁VIP
...
## lzjoy.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## manmeng168.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：番薯小说阅读器+解锁VIP
...
## manmeng168.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## mbdt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：目标地图+解锁订阅
...
## mbdt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## mdsz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：谜底时钟 +解锁全家桶订阅
...
## mdsz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## meappstore.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：中医方剂——解锁VIP
...
## meappstore.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## meetboxs.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：时光短剧-解锁会员
...
## meetboxs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## memoryhelper.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## memoryhelper.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] messagehold.js 中包含 buy.itunes.apple.com，已删除
...
## mifengzongdongyuan.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：八字排版助手——解锁VIP
...
## mifengzongdongyuan.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] mindkit.js 中包含 buy.itunes.apple.com，已删除
## mklwt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：马卡龙玩图 +解锁订阅
...
## mklwt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] mksp.js 中包含 buy.itunes.apple.com，已删除
## mofangzhice.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：一卟抠图
# 软件版本：v1.6.0
...
## mofangzhice.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## mrqge.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：每日凯格尔——解锁VIP
...
## mrqge.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## mubu.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：幕布-大纲笔记+解锁VIP
...
## mubu.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## muses.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：muses-缪思记——解锁订阅
...
## muses.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## mxdj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：梦想短剧——解锁视频播放
# 下载地址：下架了
...
## mxdj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] myfyq.js 中包含 buy.itunes.apple.com，已删除
## mytime.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：我的时间——解锁订阅
...
## mytime.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## mzbdgs.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：买怪打装备+无限兑换钻石
...
## mzbdgs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## mzj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：喵组件-——解锁VIP
...
## mzj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## mzjz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：萌猪记账——解锁VIP
...
## mzjz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## nanxiani.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：开练——解锁VIP
...
## nanxiani.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## navolove.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：熊猫睡眠——解锁VIP
...
## navolove.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]

^http[s]?:\/\/sleep.navolove.com\/api\/refresh_user_info url script-response-body https://raw.githubusercontent.com/89996462/Quantumult-X/main/ycdz/navolove.js

#[mitm] 

# hostname = sleep.navolove.com

## netpock.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：爱题词——解锁VIP
...
## netpock.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## netpock1.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：百转格——解锁VIP
# 下载地址：https://is.gd/ZHgbLg
...
## netpock1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## netpock3.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：百转格——解锁VIP
# 下载地址：https://is.gd/ZHgbLg
...
## netpock3.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## notability1.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Notability——解锁订阅
...
## notability1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] noteb.js 中包含 buy.itunes.apple.com，已删除
## noto.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：Noto 笔记+解锁订阅
...
## noto.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## nyzm.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 奶油桌面——解锁VIP
...
## nyzm.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] old.js 中包含 buy.itunes.apple.com，已删除
# [删除] onesec.js 中包含 buy.itunes.apple.com，已删除
## paike.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：派客-解锁订阅
...
## paike.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## palmestore.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：追读小说——解锁会员
...
## palmestore.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] palmsamwind.js 中包含 buy.itunes.apple.com，已删除
# [删除] pandavip.js 中包含 buy.itunes.apple.com，已删除
# [删除] paper.js 中包含 buy.itunes.apple.com，已删除
## pdfzhq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：paf 转换器-——解锁VIP
...
## pdfzhq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## percento.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## percento.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## phorase.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：phorase——解锁订阅
...
## phorase.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## photoAPP.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：photoAPP——解锁VIP
...
## photoAPP.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] pokecut.js 中包含 buy.itunes.apple.com，已删除
## pollykann.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 小鹦看看+解锁播放权限
...
## pollykann.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] pro.js 中包含 buy.itunes.apple.com，已删除
# [删除] proccd.js 中包含 buy.itunes.apple.com，已删除
# [删除] ptj.js 中包含 buy.itunes.apple.com，已删除
## ptyxj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：拼图鸭相机-解锁VIP
...
## ptyxj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qcrjqjt.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：青橙日记全家桶——解锁VIP
...
## qcrjqjt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qgzyry.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 梦剧场——解锁VIP
...
## qgzyry.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qlds.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：微信小游戏——桥梁大亨
# 脚本作者：彭于晏💞
...
## qlds.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qlmB.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：青龙面板——解锁订阅
...
## qlmB.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] qmbj.js 中包含 buy.itunes.apple.com，已删除
...
## qmzj.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## qmzj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qnewm.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：全能二维码——解锁订阅
...
## qnewm.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qnhb.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## qnhb.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qpz.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称:  趣拍——解锁订阅
...
## qpz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## quling.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：趣铃——解锁会员
...
## quling.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qupeiyin.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 日语趣配音——解锁VIP
...
## qupeiyin.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## quthing.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：灵敢提词器一解锁VIP
...
## quthing.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qwtodo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：青蛙 Todo-+解锁VIP
...
## qwtodo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qyX.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 趣颜——解锁VIP
...
## qyX.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qyxj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：轻颜相机+解锁VIP
...
## qyxj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qzxj.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称:  取证相机
...
## qzxj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## qzzvip.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：趣制作-视频剪辑+解锁VIP
...
## qzzvip.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ready.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：读否——解锁订阅
...
## ready.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## rhinoxlab.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
...
## rhinoxlab.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## rongfeng.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：地震预警——解锁VIP
...
## rongfeng.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## rongfeng1.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：舒尔特方格——解锁VIP
...
## rongfeng1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## routes.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：PeakVisor+解锁订阅
...
## routes.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## saladn.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 变美相机——解锁VIP
...
## saladn.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sanwubeixin.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：九州短剧——解锁VIP
...
## sanwubeixin.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sanwubeixin1.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：时光短剧-解锁会员
...
## sanwubeixin1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sanwubeixin11.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：电子合同易签约——解锁VIP
...
## sanwubeixin11.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] sc.js 中包含 buy.itunes.apple.com，已删除
# [删除] scanner1.js 中包含 buy.itunes.apple.com，已删除
## scdm.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：手持弹幕-——解锁VIP
...
## scdm.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sgqmx.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## sgqmx.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sgsz.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：时光手帐——解锁VIP
...
## sgsz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] sgtX1.js 中包含 buy.itunes.apple.com，已删除
## shared.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：五年日记本——解锁VIP
...
## shared.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## shashadonghua1314.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：剧推推——解锁VIP
...
## shashadonghua1314.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## shujiaxia.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：AI绘画——解锁VIP
...
## shujiaxia.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## shutiaomh.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：画耽漫画——解锁VIP
...
## shutiaomh.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## shyuhuankj.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：咔皮相机——解锁VIP
...
## shyuhuankj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sishi.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：小组件——解锁VIP
...
## sishi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sjthly.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 手机通话录音机+解锁订阅
# 特别说明：需要试用一次 每次使用开启
...
## sjthly.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sjyjgj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：手机硬件管家+解锁订阅
...
## sjyjgj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sleepo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：sleepo——解锁订阅
...
## sleepo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## slsp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：沙拉祝频——解锁订阅
...
## slsp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## smbq.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：闪萌表情-解锁VIP
...
## smbq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## smqnw.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## smqnw.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] smxcgj.js 中包含 buy.itunes.apple.com，已删除
...
# [删除] spbj.js 中包含 buy.itunes.apple.com，已删除
## starsage.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：宇宙星图
# 软件版本：v2.4.5
...
## starsage.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## starship.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## starship.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## stsq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：搜图神器+解锁VIP
# 软件版本：v1.2.7
...
## stsq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## subscribe.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：订阅酱——解锁订阅
...
## subscribe.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sylangyue.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：白马剧场——解锁VIP
...
## sylangyue.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## sym.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：水印猫
# 脚本作者：彭于晏💞
...
## sym.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## szlr.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：骰子猎人+解锁无限钻石金币
...
## szlr.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## szshht.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：视频转文字——解锁VIP
...
## szshht.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## tai1000.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：妙看——解锁VIP
...
## tai1000.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## teak.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：teak浏览器——解锁订阅
...
## teak.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## tianyancam.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：甜盐相机——解锁会员
...
## tianyancam.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] ticks.js 中包含 buy.itunes.apple.com，已删除
## tljp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：套路键盘——解锁VIP
...
## tljp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## today365.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 瑞网微视——解锁VIP
...
## today365.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## touchat.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：可奈相机——解锁VIP
...
## touchat.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ttd.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：天天豆+解锁VIP
...
## ttd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ttqingduanshi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：天天轻断食——解锁VIP
# 下载地址：https://is.gd/LSy1UH
...
## ttqingduanshi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## txwxds.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：微信读书+解锁无限卡会员
...
## txwxds.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## txzz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：头像制作——解锁VIP
...
## txzz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ubestkid.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：贝乐虎全家桶——解锁VIP内容
...
## ubestkid.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## umu168.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 脚本名称: 唔姆(解锁下载⏬)
# 脚本作者：彭于晏💞
...
## umu168.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] upp.js 中包含 buy.itunes.apple.com，已删除
## vesal.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：解剖大师——解锁VIP
...
## vesal.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] videoday.js 中包含 buy.itunes.apple.com，已删除
## vivacut.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## vivacut.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wZbz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本名称: 问真八字——解锁钻石会员权限
...
## wZbz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wakeyoga.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: Wake+解锁课程
...
## wakeyoga.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wayxtech.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：当然——解锁VIP
# 软件下载：https://is.gd/pfH9dR
# 软件版本：v2.30.1
# 脚本作者：彭于晏
# 更新时间：2023-5-25
# 问题反馈：QQ+89996462
...
## wayxtech.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]

^http[s]?:\/\/sportlight.wayxtech.com\/miniapp\/user\/getUserInfo url script-response-body https://raw.githubusercontent.com/89996462/Quantumult-X/main/ycdz/wayxtech.js

#[mitm] 

# hostname = sportlight.wayxtech.com

## wcjz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：旺财记账-——解锁VIP
...
## wcjz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wdfq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：我的番茄——+解锁订阅
...
## wdfq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wdxzj.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## wdxzj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wechat.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## wechat.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wengdehen.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：作业改改——解锁VIP
...
## wengdehen.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] westkingnet.js 中包含 buy.itunes.apple.com，已删除
...
## whalean.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：薄荷壁纸——解锁VIP
...
## whalean.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] whqsy.js 中包含 buy.itunes.apple.com，已删除
## widgetSmith.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## widgetSmith.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## widgets.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## widgets.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] widgify.js 中包含 buy.itunes.apple.com，已删除
## winner1319.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：糖果追剧——解锁VIP
# 下载地址：https://is.gd/IahsHq
...
## winner1319.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] wjglq.js 中包含 buy.itunes.apple.com，已删除
## wm4k.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：完美4K影视——解锁VIP
...
## wm4k.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wozi.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：喔知wozi背单词+解锁订阅
...
## wozi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wpzn.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：物品指南——解锁订阅
...
## wpzn.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wscreativity.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：面包拼图——解锁VIP
...
## wscreativity.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wscsds.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：网速测试大师+解锁订阅
...
## wscsds.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] wyyd.js 中包含 buy.itunes.apple.com，已删除
## wyydcd.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：网易有道词典+解锁VIP
...
## wyydcd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## wzbz123.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：吉真紫薇斗数——解锁VIP
...
## wzbz123.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xcz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：西窗烛——解锁高级会员
...
## xcz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xdplt.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：玛卡相机——解锁VIP
...
## xdplt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xdplt1.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：玛卡写真馆——解锁VIP
...
## xdplt1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xdplt6.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：抖看到小短剧——解锁VIP
...
## xdplt6.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xgkjdytt.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：笔趣阁——解锁VIP
...
## xgkjdytt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xiangha.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：烘焙小屋——解锁VIP
...
## xiangha.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xiangrikui.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：向日葵阅读+解锁VIP
...
## xiangrikui.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xiaobingkj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：集云——解锁订阅
...
## xiaobingkj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xiaoshuo.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：熊猫脑洞小说
...
## xiaoshuo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xiaoxiongyouhao.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 小熊油耗——解锁VIP
...
## xiaoxiongyouhao.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xiaoyin.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## xiaoyin.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xiegangsir.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：塔奇剧场——解锁VIP
...
## xiegangsir.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xinghuanufang.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 脚本名称:  小星星Ai陪练+解锁VIP
...
## xinghuanufang.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xinzhi.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：软眠眠——解锁VIP
...
## xinzhi.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xinzhi1.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：新知卫星地图——解锁VIP
...
## xinzhi1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xjd.js 从第1行到 [rewrite_local] 前一行：
# 
# 
# /******************************
# 
...
## xjd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xmindv.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## xmindv.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xone.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：XONE——解锁订阅
...
## xone.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## xyjsq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：迅游手游加速器+解锁VIP
...
## xyjsq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] xzj.js 中包含 buy.itunes.apple.com，已删除
...
# [删除] yase.js 中包含 buy.itunes.apple.com，已删除
## yayuanshenghuo.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：优雅高定素材
# 脚本作者：彭于晏💞
...
## yayuanshenghuo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ybxj.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 隐蔽相机
# 脚本作者：彭于晏💞
...
## ybxj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ydsmy.js 从第1行到 [rewrite_local] 前一行：
# 
# /******************************
# 
# 脚本功能：移动扫描仪+解锁VIP
...
## ydsmy.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yifanxinmei.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：今日水印拍照相机——解锁VIP
...
## yifanxinmei.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yifanxinmei1.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：今日水印拍照相机——解锁VIP
# 下载地址：https://t.cn/A6TCyiNC
...
## yifanxinmei1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yikao88.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：昭昭医考——解锁付费视频
...
## yikao88.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yimutodo.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：一木清单——解锁VIP
...
## yimutodo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yiqiqici.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：一起欺词——解锁订阅
...
## yiqiqici.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yiruikecorp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
...
## yiruikecorp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yjhl.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：一键换脸——解锁VIP
...
## yjhl.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yjkt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：一键抠图——解锁VIP
...
## yjkt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ymjz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：一木记账+解锁VIP
...
## ymjz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## youshiapp.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：有诗——解锁全家桶VIP
...
## youshiapp.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] ypjj.js 中包含 buy.itunes.apple.com，已删除
## ypjjtq.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：音频剪辑提取+解锁订阅
...
## ypjjtq.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yqjss.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：元气记时-——解锁VIP
...
## yqjss.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yqzmbz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：元气桌面壁纸——解锁会员
...
## yqzmbz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ysyk.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称:一书一课+解锁VIP
# 脚本作者：彭于晏💞
...
## ysyk.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ytxj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：一甜相机+解锁VIP
...
## ytxj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ytyd.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：一天阅读——解锁VIP
...
## ytyd.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yuan9.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：多彩相册——解锁VIP
...
## yuan9.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yueh.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 1项目名称：SODA相机
# 软件版本：1.9.1
...
## yueh.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yueji.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：阅己——解锁VIP
...
## yueji.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yunshangxiezuo.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：云上写作——解锁VIP
...
## yunshangxiezuo.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ywbj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：言外笔记-——解锁VIP
...
## ywbj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yxxj.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：隐形相机
...
## yxxj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## yywnds.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：网易蜗牛读书+解锁VIP
...
## yywnds.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] yzscq.js 中包含 buy.itunes.apple.com，已删除
## zfb.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：支付宝模拟器——解锁订阅
# 脚本作者：彭于晏💞
...
## zfb.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zhenxiang.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：相机罗盘——解锁VIP
...
## zhenxiang.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zhouyilive.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：周易起名大师——解锁VIP
...
## zhouyilive.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zhrl.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本名称: 中华日历——解锁VIP
# 脚本作者：彭于晏💞
...
## zhrl.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zhsck.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：中华诗词库——解锁VIP
# 下载地址：https://is.gd/9mxCMB
...
## zhsck.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zhuanyixia.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
# 脚本功能：转易侠扫描王——解锁VIP
...
## zhuanyixia.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zhuanyixia1.js 从第1行到 [rewrite_local] 前一行：
# /*******************************
# 
...
## zhuanyixia1.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zjbj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：指尖笔记+解锁永久VIP
...
## zjbj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] zjzgqb.js 中包含 buy.itunes.apple.com，已删除
## zkggs.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：站酷高高手——解锁会员
...
## zkggs.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zmzjz.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：最美证件照+解锁VIP
...
## zmzjz.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] znspkt.js 中包含 buy.itunes.apple.com，已删除
# [删除] znzdw.js 中包含 buy.itunes.apple.com，已删除
## zt.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：佐糖-一键抠图+解锁VIP
...
## zt.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ztbl.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：真题伴侣一解锁VIP
...
## ztbl.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## ztc.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：字体册——解锁订阅
...
## ztc.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
# [删除] ztqs1.js 中包含 buy.itunes.apple.com，已删除
## zxhdmx.js 从第1行到 [rewrite_local] 前一行：
# /*************************************
# 
# 项目名称：真心话大冒险——解锁订阅
...
## zxhdmx.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
## zxktkj.js 从第1行到 [rewrite_local] 前一行：
# /******************************
# 
# 脚本功能：草莓短剧——解锁VIP
...
## zxktkj.js 中的 [rewrite_local] 到 hostname:
#[rewrite_local]
...
hostname = %APPEND%api4.bybutter.com,(.*|api-chat.soulapp.cn),(ms.51wnl-cq.com|lxy.51wnl-cq.com),(partner-ai-api.quthing.com|partner-ai-api.quthing.com),(screen-lock.sm-check.com|lxy.51wnl-cq.com),(youshiapp.com|judouapp.com|lengapp.com),*.aoscdn.com,*.apsapp.cn,*.feihua100.com,*.iwzbz.com,*.kuwo.cn,*.lrts.me,*.lanjiyin.com.cn,*.oracle.bendingspoonsapps.com,*.radio.cn,*.rhinox*.com,appss.linhongshi.com,*hj*,*haijiao*,.*-api.quthing.com,.*.meitu.com,111.229.140.167,123.56.125.184,182.92.64.124,1jietu.com,39.108.85.85:17012,47.108.54.158,47.112.75.234,today.xhey.top,8.149.129.124,a.xinzhi.space,account.wps.cn,accounts.agenda.com,ai-pic.xdplt.com,ai.yayuanshenghuo.xin,aicblhapp.ubestkid.com,aifaceapi.meetboxs.com,aihh.shujiaxia.com,akdj.lunlunkj.vip,ap*.intsig.net,api-*.meitu.com,api-aidraw.3dmoxiu.com,api-production.endel.io,api-sub.meitu.com,api-v3.speedtest.cn,api-webclip.wdxzj.com,api-yread-online.du.youdao.com,api.233.com,api.528529.com,api.6pen.art,api.adapty.io,api.aidimension.cn,api.aijpq.com,api.apphud.com,api.assistantwriter.top,api.bluepulse.cn,api.boohee.com,api.busuu.com,api.chatgdp4.com,api.chatmoon.cn,api.chiyue365.com,api.chuangqi.store,api.cikelink.com,api.craft.do,api.ddcsai.com,api.deepfaker.app,api.dianyinge.com,api.duitang.com,api.duoyolo.cn,api.everjournal.life,api.fengkuangapp.com,api.geefoo.cn,api.gogoup.com,api.gotokeep.com,api.haokanke.com,api.hcreator.cn,api.huaya.cc,api.hujuvod.com,api.iappdaily.com,api.io111.com,api.jianmovie.com,api.jumirui.com,api.keyboard.buzhedie.com,api.kmovie.gifshow.com,api.lingokids.com,api.mag-store.com,api.mattingm.com,api.meiyan.com,api.memrise.com,api.mojidict.com,api.mondlylanguages.com,api.open.loveclip.site,api.pollykann.com,api.pxmage.com,api.qingning6.com,api.qmxfs.com,api.revenuecat.com,api.revenuecat.com,api.rc-backup.com,api.revenuecat.com,app-measurement.com,*.googleapis.com,api.revenuecat.com、rc-backup.com,api.saladvideo.com,api.sevenworkouts.com,api.shaolinzen.com,api.shouzhang.com,api.shuashuati.com,api.sortedapp.com,api.starsage.cn,api.tai1000.com,api.taolujianpan.com,api.tapeacall.com,api.tiantiantiaosheng.com,api.tipsoon.com,api.v1.esread.com,api.vesal.cn,api.wakeyoga.com,api.weilaizhushou.com,api.widgetbox.top,api.wondercv.com,api.xgkjdytt.cn,api.xiuxiu.meitu.com,api.xunyou.mobi,api.yikao88.com,api.yikaobang.com.cn,api.yonekura.cn,api2.mubu.com,api3.umu168.com,apidj.meetboxs.com,apigate.zymk.cn,apiios_dq.xiangha.com,apiv2.hula123.com,app.api.versa-ai.com,app.cdmgkj.cn,app.gaohaozuowen.com,app.huashijie.art,app.lalaldc.cn,app.rongfeng.work,app.whjxjz.cn,app.yidiansz.com,app.zomoplan.com,appapi.pipimanhua.cc,apps-api.lianaishouce.cn,apps-api.lingege.cn,appss.linhongshi.com,appss.rhinoxlab.com,appv2.filmix.com.cn,appwk.baidu.com,asia.gikken.co,askquin.cn,awvp.aoscdn.com,azory.lumosfun.com,backend.getdrafts.com,baimiao.uzero.cn,beauty.laoyingdev.com,biz.cyapi.cn,bluediary-d0778.du.r.appspot.com,bmall.camera360.com,book.haitunwallet.com,bookapi.ellabook.cn,bread28resapi.wscreativity.com,buy.videoshowiosglobalserver.com,bzpp2.iwzbz.com,c-api.wjpaa.cn,calc.kuaicad.com,callrecorder.icamscanner.com,candydjapi.winner1319.top,carrotweather.herokuapp.com,cc.lzjoy.com,cdn-bm.camera360.com,changeclothes.szsszykj.com,chat.zyhd02.cn,clean.tzdoc.com,closet.jinjian.tech,cm.szsszykj.com,cn-rest.dhcn.greenergrass.games,cn.invit.vip,cocamapi.imendon.com,commerce-api.faceu.mobi,compass.xinzhi.space,cs.kuso.xyz,csj.yy-5.com,cubox.pro,curriculum-api.yizhiweixin.com,data.ufbae.com,data.watchoutwidgets.com,day-api.xixitime.com,dayone.app,diary-id.sumi.io,dict.youdao.com,dida365.com,dj.palmestore.com,djcsk-api.y2-3.com,donate-api.recorder.duapps.com,dq.xiangha.com,apiios_dq.xiangha.com,duoman.flyingeffect.com,ec.myjkyd.com,english.dolphinmedia.cn,exam.dxy.cn,expire.vanemu.com,face.app.superclear.cn,fast.lmfasting.cn,fbapi.meetboxs.com,fcapi.91por.vip,ff.mofangzhice.com,fitness-notes.nanxiani.cn,flomoapp.com,footprint-api.quthing.com,format-api.netpock.com,frogtodo.shuge888.com,fufei.fengyunsoft.cn,fufei.haitubangong.com,fxshot-api.afunapp.com,fz68resapi.imendon.com,g20.manmeng168.com,gateway-pro.caishi.cn,gateway.apphud.com,gateway.ergediandian.com,gdw.xinzhi.space,getway-plan.abuddz.com,ggs.manmeng168.com,giftstore.work,graphql.flowkey.com.cn,great.starsdsea.com:12502,gs.gateway.gameley.cn,gugu.zomoplan.com,gushici.91iread.com,gw.aoscdn.com,hi-api.weshineapp.com,honeydjapi.amkj.shop,huyitool.jidiandian.cn,i.weread.qq.com,iap.etm.tech,idp2api.netpock.com,ig.api.pangbaoapp.com,igetcool-gateway.igetcool.com,integral.dasyibalang.com,integral2.zhijiantime.com,iosbmxj.sanwubeixin.cn,iosdzhtyqy.sanwubeixin.cn,iosqsy.lmzjz.sanwubeixin.cn,iosqwrmdj.sanwubeixin.cn,iosshortplay.sanwubeixin.cn,iossjlplds.sanwubeixin.cn,iosv2.cjapi.5fun.com,iosv2.cjapi.wufan88.com,iosv2.cjapi.wufan88.com,iosv2.cjapi.5fun.com,iosxqsdnew.sanwubeixin.cn,iosyxdzyyxc.sanwubeixin.cn,ioszbjtmnsq.sanwubeixin.cn,iosahy.lmihyan.sanwubeixin.cn,iosznsmw.lmscanner.sanwubeixin.cn,itcapi.netpock.com,itheme.thinkingcloud.net,japaneselar.qupeiyin.com,jianzhibao1688.cn,judouapp.com,kapi-action.shyuhuankj.com,kegelapi.dailystretch.app,kk.weshine.im,kk.weshine.im,kk-flow.weshine.im,kkgif.weshine.im,api-access.pangolin-sdk-toutiao.com,api-access.pangolin-sdk-toutiao1.com,api-access.pangolin-sdk-toutiao-b.com,gromore.pangolin-sdk-toutiao.com,open.e.kuaishou.com,*.anythinktech.com,*.metricslinks.com,mi.gdt.qq.com,win.gdt.qq.com,sdk.e.qq.com,sdkquic.e.qq.com,v3.gdt.qq.com,c3.gdt.qq.com,pgdt.ugdtimg.com,adsmind.ugdtimg.com,log-api.pangolin-sdk-toutiao.com,log-api.pangolin-sdk-toutiao-b.com,toblog.ctobsnssdk.com,sdk.beizi.biz,*.yunxish.com,*.hookspf.com,*.hubcloud.com.cn,*.ad-scope.com.cn,koan.bopulab.cn,kt.jiaofei8.cn,laoniu.dicallapp.com,lchttpapi.xczim.com,lchttpapi.xczim.com,lchttpapi.xczim.com,lchttpapi.xczim.com,lcs-mobile-cops.adobe.io,license.pdfexpert.com,ljwapi.baichuan.tech,m2u-api.getkwai.com,map.kky888.cn,market-gateway.julanling.com,mars-prod.whalean.com,mars.inout.top,mconf.douyucdn.cn,apiv2.douyucdn.cn,apiv3.douyucdn.cn,rtbapi.douyucdn.cn,medi.dxzzy321.top,medicine-books.meappstore.top,memoryhelper.fujianjin6471.com,mid.zineapi.com,miniapp.guniuniu.com,mobile-ios-wallpaper-api.zhhainiao.com,mobile-new.chinaeew.cn,mobile.ktvme.com,motu.touchat.online,mp.weixin.qq.com,mv-ps.xdplt.com,nanie.flyingeffect.com,nao.ganbuguo.com,newtest.zoooy111.com,newtest.zoooy111.com,notability.com,novel.test.onedayapp.cn,nowapi.navoinfo.cn,nz-api.duitang.com,open3.vistastory.com,operationshomework.wengdehen.top,oxfordx.cp.com.cn,p.du.163.com,painting-api.aimusician.cc,paperwork.szshht.cn,pay-motu.doglobal.net,pay.wecut.com,payment-api.lingvist.com,payments.invideo.io,pc7dong.com,peakvisor.com,pgapi.ksmobile.com,photo.yuan9.cn,photoby.hasmash.com,photos.adobe.io,poster.leminet.cn,proxyweb.huikao8.com,purchase-foodiecn-api.yiruikecorp.com,purchase-qingtu-api.b612kaji.com,purchase-tianyan-api.tianyancam.com,purchases.ws.pho.to,puzzle.xcxsc.net,qianji.xxoojoke.com,qr.duomihongbao.cn,quickapi.xiegangsir.com,quyan.aifaceshow.com,restore-access.indream.app,ruanmianmian.xinzhi.space,rzres86api.imendon.com,rzres86api.imendon.com,api-access.pangolin-sdk-toutiao.com,s.mcwifi.cn/hw,saomiao.34354.com,scanner.jianse.tv,sdk.api.appwheel.com,server1.xxxy.dayukeji.com,service.ilovepdf.com,shared.lc-cn-n1-shared.com,shortplay.shashadonghua1314.com,silimini.bigwinepot.com,sleep.navolove.com,soti.ixyzh.com,sportlight.wayxtech.com,ssl-api.itranslateapp.com,storybook.ifenghui.com,strawberrydjapi.zxktkj.top,supercamera.yifanxinmei.com,teleprompter-api.quthing.com,tfbook.taoyuewenhua.net,tybook.taoyuewenhua.net,tgz.jiaofei8.cn,theater-api.sylangyue.xyz,ticket-api.aimusician.com.cn,tool.qgzyry-gov.com,top-widgets-api.xiaozujian.com,ttlnt.wedo-lnt.com,tutugushiapi.tutuerge.com,us-central1-imin-aa206.cloudfunctions.net,user-kaji-api.b612kaji.com,user.xiaozaoapp.com,vip.deliocr.cn,vip.zhuanyixia.cn,vipapi.jxedt.com,vira.llsapp.com,voicechat.enlargemagic.com,wallpaper.soutushenqi.com,water-fst.yifanxinmei.com,water-fv.jslynhapi.com,watersymaoa.yunxiaoguo.cn,weimage.keephu.com,widget.haoqimiao.net,widgets-api.kaixinyf.cn,wnl28.jiemengjia.com,writer.saladn.xyz,wsapi.today365.com.cn,www-lf.ggl.cn,www.40sishi.com,www.babybooks.top,www.caaaat.com,www.doctorsclass.com,www.evestudio.cn,www.freshhome.top,www.fuyoutech.club,www.guga.co,www.helloshiyu.com,www.huojiwangluo.cn,www.ljw.sc.cn,www.longstargpt.com,www.lovewith.me,www.ohaiyocam.com,www.shutiaomh.com,www.skyjos.cn,www.ttqingduanshi.com,www.wonzeecam.top,www.xiaoxiongyouhao.com,www.xmind.cn,www.yunshangxiezuo.com,www.zhongkao66.com,www.zhouyilive.com,wx-xmlb.lanfeitech.com,wxsdk-data.d3games.com,xblmath.youban.com,xblpay.youban.com,xckj.xingcenkj.com,xianbeikeji.com,xiaogou.dicallapp.com,xiaoshuo.xmxsapp.com,xiaoxingxing.xinghuanufang.cn,xihongshi.dicallapp.com,xkld.kunpengtn.com,xrckeji.com,xw.jietuguanjia.com,xy-viva.kakalili.com,api-chn.rthdo.com,xy.jingcle.com,xz1.mifengzongdongyuan.com,yimuapp.com,yimutodo.com,ys.qquanyun.top,yueh.app168.cc,yw.jiaofei8.cn,yyy.bosum.com,zebra.maka.im,zhengjian.flyingeffect.com,zhenxiang.net.cn,zsbt.apisrv.cn,zwpp.wzbz123.com
